...
public class VictimsRecordTest extends TestCase {
    ...
    public void testToJSON() {
        ...
        MetadataRecord mani = new MetadataRecord();
        mani.filename = "MANIFEST.MF";
        mani.properties.put("somekey", "somevalue");
        mani.properties.put("somekey", "somevalue");
        mani.properties.put("somekey", "somevalue");
        mani.properties.put("somekey", "somevalue");

        MetadataRecord pom = new MetadataRecord();
        pom.properties = mani.properties;
        pom.filename = "pom.properties";

        rec.meta = new MetadataRecord[]{ mani, pom };
