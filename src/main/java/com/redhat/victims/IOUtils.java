...
/**
 * A collection of miscellaneous utilities used throughout the plug-in to 
 * format output.
 *
 * @author gmurphy
 */
public final class IOUtils {
   ...
   public static String repeat(char c, int n) {
    ...
    public static String prettyPrint(String title, JSONObject o) {
        ...
        while (i.hasNext()) {
            ...
            try {
                ...
                sb.append("Invalid format of JSON object: ")
                  .append(o.toString())
    ...
    /** 
     * A rather lousy way at altering the logging level based on the 
     * mode of operation that the rule has been configured for. 
     * 
