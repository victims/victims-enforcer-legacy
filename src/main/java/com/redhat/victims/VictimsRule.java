 ...
 * plug-in. It provides the logic to synchronize a local database with a
 * remote database of vulnerable Java artifacts. This database is used to check
 * for any dependencies used within the project that may have known 
 * vulnerabilities. 
 * 
 * @author gmurphy
 */
public class VictimsRule implements EnforcerRule {
     ...
     * import of entries will take some time but subsequent requests should 
     * be relatively fast. 
     * 
