 ...
 * the VictimsRule are validated and initialized with defaults from this 
 * class. 
 * 
 * @author gmurphy
 */
public final class Settings {
    ...
    /* Different settings that can be configured. These need to map back to 
     * the names of each of the private members in the rule definition in order
     * to be configurable in the pom.xml @see VictimsRule
     */
